# OpenAPI\Client\EmbeddedFlowApi
...
```php
initPayment($x_ef_sender_ip, $x_ef_sender_user_agent, $inline_object1): \OpenAPI\Client\Model\InlineResponse2003
```
...
```php
processPayment($id, $inline_object2): \OpenAPI\Client\Model\InlineResponse2006
```
